        ...
        // Group Creation
            ...
            if (groupName.indexOf('/')>-1) {
                ...
                .toFile("tempUploads/"+req.body.username+'.png', (err, info) => { 
                    ...
                    dilabConnection.query(`INSERT INTO DilabMusicGroups (groupName, groupPicture,description, admin, founder, genres) VALUES ('${groupName}','${groupName}.png','${groupDescription}',${req.session.dilab},${req.session.dilab},'${groupOrientation}')`,function(err,results,fields) {
                        if (err) {
